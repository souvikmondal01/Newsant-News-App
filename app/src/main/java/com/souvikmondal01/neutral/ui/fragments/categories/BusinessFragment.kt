...
import com.souvikmondal01.neutral.utils.Constants.BUSINESS
...
class BusinessFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = NewsAdapter(
            this, viewModel, R.id.action_categoryFragment_to_webViewFragment
        )
    ...
    private fun setDataToAdapter() {
        lifecycleScope.launch(Dispatchers.IO) {
            viewModel.getCategoryNews(BUSINESS, apiKey.await()).collectLatest {
