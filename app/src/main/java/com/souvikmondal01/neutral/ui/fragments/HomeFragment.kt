...
import com.souvikmondal01.neutral.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = NewsAdapter(this, viewModel, R.id.action_homeFragment_to_webViewFragment)
    ...
    private fun setDataToAdapter() {
        lifecycleScope.launch(Dispatchers.IO) {
            viewModel.getBreakingNews(apiKey.await()).collectLatest {
